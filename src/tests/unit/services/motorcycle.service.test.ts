...
describe('Motorcycle Service', () => {
	...
	describe('Delete Motorcycle', () => {
		it('Success', async () => {
			const motorcycleDelete = await motorcycleService.delete(motorcycleMockWithId._id);
	...
	describe('Update Motorcycle', () => {
		it('Success', async () => {
			const motorcycleArray = await motorcycleService.update(motorcycleMockWithId._id, motorcycleMockForUpdate);
      ...
      let error;
			try {
				await motorcycleService.update(motorcycleMockWithId._id, motorcycleMockForUpdateWrong);
			} catch (err:any) {
				error = err
			}
